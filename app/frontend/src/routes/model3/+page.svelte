...
<div class="mx-auto max-w-4xl">
	<h1 class="text-center text-2xl font-bold">Car Price Prediction (New Model)</h1>
	<div class="mb-4 text-center text-gray-700">
		<p>This is the 3rd model to classify price of car into 4 groups</p>
		<p>Cheap, Moderate, Expensive, Luxurious</p>
		<p>Put your car details below to get an estimated price.</p>
